...
export default function StudentPortal() {
  ...
  switch (section) {
    ...
    case 'groups': content = <GroupsHub title="Education Community" subtitle="Join study circles and school-linked communities with controlled membership and moderation" accent="var(--forest)" />; break;

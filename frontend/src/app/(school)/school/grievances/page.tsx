...
export default function SchoolGrievancesPage() {
  ...
  return <div className="animate-fade-up">
    ...
    <p className="text-sm mb-4" style={{color:'var(--slate)'}}>Formal Parent concerns for students linked to your school. Acknowledge promptly, keep communication on the ticket, and record a clear resolution.</p>

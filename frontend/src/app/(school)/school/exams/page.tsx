...
export default function SchoolExamsPage() {
  ...
  const classNames = useMemo(() => sortSchoolGradeValues([...new Set((classesQ.data || []).map((schoolClass) => schoolClass.class_name))]), [classesQ.data]);
  ...
  function validateCreate() {
    ...
    if (new Date(form.endTime) <= new Date(form.startTime)) return toast.error('Exam end time must be after the start time');

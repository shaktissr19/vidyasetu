...
const CONFIG: PublicModuleConfig = {
  ...
  summary: 'The Platform Admin experience is for VidyaSetu operations—not School Admins. It covers platform analytics, schools, users, content, revenue, support, competitions, configuration and Group governance.',
  ...
  steps: [
    ...
    { title: 'Observe the network', description: 'Start from analytics, schools, users, content, revenue and support views.' },
    { title: 'Take governed actions', description: 'Change account states, manage configuration, create competitions and review Group lifecycle decisions.' },
    { title: 'Audit platform health', description: 'Use operational views to monitor adoption, issues, governance queues and platform configuration.' },
  ],
  proofTitle: 'Protected platform operations already implemented',
  proofIntro: 'These areas map directly to current SUPER_ADMIN routes and are intentionally separated from School Admin functionality.',
  proofs: [
    ...
    { icon: '🛠️', title: 'Support & configuration', description: 'Support tickets and platform configuration have dedicated admin workflows.' },
    { icon: '🛡️', title: 'Competitions & Groups', description: 'Platform-level competition creation and full Group governance are part of Admin.' },
  ],
  loginTitle: 'Login to Platform Admin',
  loginText: 'Platform analytics, user controls, support tickets and governance actions are restricted to authorised Platform Administrators.',
};

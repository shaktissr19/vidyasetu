...
export const completeStudentProfile = <T extends object>(payload: T) => api.post('/student/profile/complete', payload);
...
export const getReportCard = (term?: string, year?: string | number) => api.get('/student/report-card', { params: { term, year } });

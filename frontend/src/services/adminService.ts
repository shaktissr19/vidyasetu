...
export const updateSchoolStatus = (id: string, status: string) =>
  api.patch(`/admin/schools/${id}/status`, { status });
...
export const updateTicket = <T extends object>(id: string, body: T) =>
...
export const createExam = <T extends object>(body: T) => api.post('/admin/competitions', body);

...
import studentLibraryRoutes = require('./routes/studentLibrary.routes');
...
import schoolLibraryRoutes = require('./routes/schoolLibrary.routes');
...
import parentLibraryRoutes = require('./routes/parentLibrary.routes');
...
app.use(`${API}/school/library`, schoolLibraryRoutes);
...
app.use(`${API}/parent/library`, parentLibraryRoutes);

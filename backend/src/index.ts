...
import schoolRegistrationRoutes = require('./routes/schoolRegistration.routes');
...
import parentRegistrationRoutes = require('./routes/parentRegistration.routes');
...
import adminRegistrationRoutes = require('./routes/adminRegistration.routes');
...
app.use(`${API}/parent`, parentRegistrationRoutes);

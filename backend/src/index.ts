...
import notificationInboxRoutes = require('./routes/notificationInbox.routes');
...
import parentWorkflowRoutes = require('./routes/parentWorkflow.routes');
...
app.use(`${API}/parent`, parentWorkflowRoutes);

...
router.get('/enrollment-requests', enrollmentCtrl.getSchoolRequests);
router.patch('/enrollment-requests/:requestId', validate(enrollmentReviewSchema), enrollmentCtrl.reviewSchoolRequest);

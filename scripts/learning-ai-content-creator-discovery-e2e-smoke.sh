...
VIDEO_SEARCH="$(curl -fsS -X POST "$API_BASE/admin/learning/creator/discovery/search" "${AUTH[@]}" -H 'Content-Type: application/json' -d '{"providers":["LOCAL","NROER","CBSE","NCERT_EPATHSHALA","NIOS","SWAYAM","PHET","OER_COMMONS"],"query":"Force and Pressure","classNumber":8,"subject":"Science","mediaKinds":["VIDEO"],"maxDurationMinutes":10,"limit":20}')"
